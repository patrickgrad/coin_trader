...
class Buyer:
    ...
    def place_order(self, msg):
        ...
        size = max(min(self.exchange.avg_volume, self.exchange.balance_usd/self.our_bid), self.exchange.product["base_min_size"])
        ...
        try:
            ...
            self.log_info("buy {} @ {} success".format(size, self.our_bid))
        except KeyError:
